 ...
 * 
 */
@WebServiceClient(name = "TestWS", targetNamespace = "http://ws.psd.safaricom.com/", wsdlLocation = "http://2a1ba6a5.ngrok.io/TestWebService/TestWS?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://2a1ba6a5.ngrok.io/TestWebService/TestWS?wsdl");
